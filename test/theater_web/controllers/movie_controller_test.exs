defmodule TheaterWeb.MovieControllerTest do
  use TheaterWeb.ConnCase

  alias Theater.Entertainments

  @create_attrs %{summary: "some summary", title: "some title", year: 42}
  ...
  def fixture(:movie) do
    {:ok, movie} = Entertainments.create_movie(@create_attrs)
    movie
  end
